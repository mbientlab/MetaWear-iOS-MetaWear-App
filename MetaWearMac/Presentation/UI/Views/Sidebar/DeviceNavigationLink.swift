...
private extension DeviceNavigationLink {
    ...
    func makeCellVC() -> MWScannedDeviceCellSVC {
        isDiscoveredList
        ? app.ui.makeScannedDeviceCellSVC(scannerItem: vc.discoveredDevices[index], parent: vc) as! MWScannedDeviceCellSVC
        : app.ui.makeScannedDeviceCellSVC(device: vc.connectedDevices[index], parent: vc) as! MWScannedDeviceCellSVC
    }
